                    ...
                    colTours.map(tour => (
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          {col.id === 'PLANNING' && (
                            <>
                              <div><strong style={{ color: 'var(--text-secondary)' }}>Scoping:</strong> {tour.sales?.targetCustomers || 20} Pax Target</div>
                              <div><strong style={{ color: 'var(--text-secondary)' }}>Est. Revenue:</strong> {formatINR(tour.finance?.plannedRevenue || 1000000)}</div>
                            </>
                          )}
                          {col.id === 'REVIEWING' && (
                            <>
          ...
          <table className="table" style={{ width: '100%', minWidth: '1000px' }}>
            <thead>
              <tr>
                ...
                <th style={{ textAlign: 'right' }}>Target Pax</th>
            ...
            <div style={{ padding: '2rem' }}>
              {isEditingTour ? (
                <div className="animate-slide-up" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                    <div className="form-group" style={{ marginBottom: 0 }}>
                      <label className="form-label">Target Customers (Seats)</label>
                ...
                <div className="animate-slide-up" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                  ...
                  <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--glass-border)' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between' }}><span style={{ color: 'var(--text-secondary)' }}>Target Seats:</span> <strong style={{ color: '#fff' }}>{selectedTour.sales?.targetCustomers || 20}</strong></div>
                      <div style={{ display: 'flex', justifyContent: 'space-between' }}><span style={{ color: 'var(--text-secondary)' }}>Target Revenue:</span> <strong style={{ color: '#00E676' }}>{formatINR(selectedTour.finance?.plannedRevenue || 1000000)}</strong></div>
                    </div>
                  </div>
